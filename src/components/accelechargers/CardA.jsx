...
import styles from './Accele.module.css';
...
const Card = () => {
  ...
  useEffect(() => {
    fetch('https://raw.githubusercontent.com/Jopefv/api-acce/main/accele.json')
  ...
  const filteredCards = cards.filter((filme) => filme.Type === 'Accelechargers');
