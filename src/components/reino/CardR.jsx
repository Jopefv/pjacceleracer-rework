...
import HidroLogo from '../../assets/rodas/hidro.png';
import SpikeLogo from '../../assets/rodas/spike.png';
import SlickLogo from '../../assets/rodas/slick.png';
import OffroadLogo from '../../assets/rodas/offroad.png';
...
const Card = () => {
  ...
  useEffect(() => {
    fetch('https://raw.githubusercontent.com/Jopefv/api-acce/main/realms.json')
  ...
  const filteredCards = cards.filter((filme) => filme.Type === 'Realm');
      ...
      {filteredCards.map((filme) => (
        <section className={styles.card} key={filme.id}>
          <div className="team-logo-container">
            ...
            <img
              className="logo2"
              src={getLogoPath(filme.Tyres)}
              alt={`${filme.Tyres} Logo`}
              width="30"
              height="30"
            />
          </div>
